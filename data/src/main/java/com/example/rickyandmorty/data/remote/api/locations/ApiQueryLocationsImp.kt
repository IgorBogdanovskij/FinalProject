package com.example.rickyandmorty.data.remote.api.locations

import com.example.rickyandmorty.domain.models.location.ResponseApiLocations
...
class  ApiQueryLocationsImp(
    ...
    override fun getSingleLocation(number: Int): Single<com.example.rickyandmorty.domain.models.location.Location> {
