package com.example.rickyandmorty_finalproject_anderson.presentation.detailsLocations.ui.recycler
...
class AdapterDetailsLocations(
    private val context: Context,
    private val callback: OnClickEventDetailsLocationRv,
    private val onHolderEventListener: OnHolderEventListener
) :
    RecyclerView.Adapter<AdapterDetailsLocations.ViewHolder>() {
    ...
    interface OnClickEventDetailsLocationRv {
    ...
    inner class ViewHolder(private val binding: ItemHeroBinding) :
        ...
        init {
            binding.root.setOnClickListener { callback.onClickHero(mListCharacters[adapterPosition]) }
        }
