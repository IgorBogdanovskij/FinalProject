...
import com.example.rickyandmorty.data.locale.dataBase.DataBaseRickyMorty
import com.example.rickyandmorty.data.remote.api.episodes.ApiQueryEpisodes
import com.example.rickyandmorty.data.remote.api.episodes.ApiQueryEpisodesImp
import com.example.rickyandmorty.data.remote.api.heroes.ApiQueryHeroes
import com.example.rickyandmorty.data.remote.api.heroes.ApiQueryHeroesImp
import com.example.rickyandmorty.data.remote.api.locations.ApiQueryLocations
import com.example.rickyandmorty.data.remote.api.locations.ApiQueryLocationsImp
import com.example.rickyandmorty.data.repository.RepositoryEpisodesImp
import com.example.rickyandmorty.data.repository.RepositoryHeroesImp
import com.example.rickyandmorty.data.repository.RepositoryLocationsImp
